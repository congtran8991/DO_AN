...
class Evalute extends Component {
    constructor(props) {
        super(props);
        this.state = {
            showEx: false,
    ...
    render() {
        // sessionStorage.dataChuong = JSON.stringify(this.state.showDataEvaluate.chaptersTest);
        // sessionStorage.dataSave = JSON.stringify(this.state.showDataEvaluate);
...
export default withRouter(connect(mapStateToprops, mapDispathToprops)(Evalute))
